...
import ListCharacter from "../../src/components/list";

describe('listCharacter component', () => {
  it('Should render a list of characters', () => {
    ...
    // act
    const { getByTestId, getAllByTestId } = render(<ListCharacter data={mockCharacters} />)
